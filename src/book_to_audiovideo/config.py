...
class Settings(BaseSettings):
    ...
    default_llm_model: str = Field(default="qwen/qwen3.6-27b", alias="DEFAULT_LLM_MODEL")
    ...
    groq_segment_token_budget: int = Field(default=2000, alias="GROQ_SEGMENT_TOKEN_BUDGET")
    ...
    groq_enrichment_token_budget: int = Field(default=2200, alias="GROQ_ENRICHMENT_TOKEN_BUDGET")
